...
import { ArrowDownRight, Box, Code2 } from 'lucide-react';
  ...
  return (
    <header className="px-4 py-16 md:py-24 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-4 flex justify-center md:justify-end">
            <div className="w-full aspect-square border-4 border-[#1B3C53] neo-shadow bg-[#456882] relative overflow-hidden flex items-center justify-center p-8 group">
                <div className="absolute inset-0 bg-[#1B3C53] opacity-20" style={{ backgroundImage: "radial-gradient(#E3E3E3 1px, transparent 1px)", backgroundSize: "20px 20px" }}></div>
                <Box strokeWidth={1.5} className="w-32 h-32 text-[#E3E3E3] group-hover:scale-110 transition-transform duration-300" />
